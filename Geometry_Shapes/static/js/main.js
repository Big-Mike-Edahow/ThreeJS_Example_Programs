...
function main() {
  ...
  const texture = loader.load("static/textures/uv_grid_opengl.jpg");
  texture.colorSpace = THREE.SRGBColorSpace;

  // Settings tocorrectly display the texture on a shape geometry.
  ...
  // Add shape. Parameters: shape, color, x, y, z, rx, ry,rz, s.
  addShape(
    californiaShape,
    extrudeSettings,
    0xf08000,
